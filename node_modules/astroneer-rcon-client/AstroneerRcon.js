                            ...
                            this._.eventLoop = async () => {
                                ...
                                if(this._.socket.writable == true){
                                    this.sendRaw("ListGames\nDSListPlayers").then(async response => {
                                        ...
                                        // Parse the data
                                        let newList = []
                                        // Check if players response exists before parsing
                                        if (!players || !players.playerInfo) {
                                            console.error('RCON listPlayers response missing playerInfo:', players)
                                            players = []
        ...
        return new Promise((resolve) => {
            this.sendRaw("ListPlayers").then(response => {
                ...
                if (!response || !response.playerInfo) {
                    console.error('RCON ListPlayers response missing playerInfo:', response)
                    resolve([])
                    return
                }
