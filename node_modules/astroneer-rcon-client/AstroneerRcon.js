                                    ...
                                    this.sendRaw("ListGames\nDSListPlayers").then(async response => {
                                        ...
                                        if(this._.eventCache.players == null){
                                            ...
                                            for(let i = 0; i < players.length; i++){
                                                ...
                                                for(let ii = 0; ii < this._.eventCache.players.length; ii++){
                                                    ...
                                                    if(player.guid == cachePlayer.guid){
                                                        copy[i] = null  // Use current player index, not cached index
                                                        // Handle changes
                                                        ...
                                                        if(cachePlayer.category != player.category){  // Bug fix: was ==, should be !=
                                            ...
                                            for(let i = 0; i < copy.length; i++){
                                                ...
                                                // Validate player data before emitting
                                                if(copy[i] && copy[i].guid && copy[i].name){
                    ...
                    let apply = () => {
                        if(player.category == "Owner"){
                            ...
                            if(player.name == ""){
                                ...
                                // Quote the player name to handle spaces properly
